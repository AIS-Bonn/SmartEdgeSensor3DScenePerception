...
struct FUSION_BODY_PARTS {
    ...
    static constexpr int kpParent[NUM_KEYPOINTS]      = {-1, 0,    1,    2,    3,    1,    5,    6,    20,   1,    9,     10,   1,    12,   13,    0,    0,    15,   16,   0,    1}; // TODO: Connection 9-1 and 12-1 are specific for EdgeTPU OpenPose model. Actually this should be 9-8 and 12-8.
